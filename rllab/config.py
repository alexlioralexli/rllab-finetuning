...
CODE_SYNC_IGNORES = ["*.git/*", "*data/*", "*.pod/*", "*sandbox/sac/*"]

DOCKER_CODE_DIR = "/root/code/rllab"  #todo: is this what's breaking it?
...
FAST_CODE_SYNC_IGNORES = [".git", "data", ".pods", "videos", "*sandbox/sac/*"]
