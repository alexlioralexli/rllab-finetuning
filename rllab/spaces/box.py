...
#for the openai gym integration
from gym.spaces import Box as OpenAIBox  #todo: remove after the baselines check

class Box(Space, OpenAIBox):
    """
    A box in R^n.
    ...
    # todo: added for openai baselines
    @property
    def dtype(self):
