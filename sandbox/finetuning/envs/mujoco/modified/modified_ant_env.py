...
from sandbox.finetuning.envs.mujoco.ant_env import AntEnv as AntLowGearEnv


class ModifiedAntEnv(AntLowGearEnv, Serializable):
    ...
    def __init__(self, param_name=None, multiplier=np.ones((14, 1)), *args, **kwargs):
...
if __name__ == '__main__':
    env = ModifiedAntEnv(ego_obs=True)
