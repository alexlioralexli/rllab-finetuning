...
class HierarchicalContinuousPolicy(StochasticPolicy, LasagnePowered, Parameterized, Serializable):
    """
...
1
    ...
    def get_action(self, observation):
        ...
        if self.count % self.period == 0:  # sample a new latent skill
            ...
            if self.continuous_latent:
                self.curr_latent = latent[0]  #i think the shape should be right now
                import ipdb; ipdb.set_trace()
            else:
