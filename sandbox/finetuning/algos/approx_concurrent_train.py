...
class PG_concurrent_approx(BatchPolopt):
    """
    ...
    def __init__(self,
        ...
        if optimizer is None:
            ...
            self.optimizer = FirstOrderOptimizer(learning_rate=step_size, max_epochs=1, **optimizer_args)  # I hope this is right
    ...
    def optimize_policy(self, itr, samples_data):
        ...
        # advantage_sparse = np.sum(input_values[2].reshape([input_values[2].shape[0]//self.period, self.period]), axis=1) # todo: old advantages
