...
from sandbox.finetuning.distributions.categorical import from_index, from_onehot
...
class NPO_snn(NPO):
    ...
    - allows to give rewards for several divergence metrics among conditional distributions (through BatchSampler_snn)
